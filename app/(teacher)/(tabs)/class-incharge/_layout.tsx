...
import { Platform, Text, View, ActivityIndicator, Image, TouchableOpacity, Pressable, Modal } from "react-native";
...
const MENU_ITEMS = [
  {
    label: "Students",
    route: "/class-incharge/students",
    icon: "users",
    IconType: Feather,
  },
  {
    label: "Subjects",
    route: "/class-incharge/marks-entry",
    icon: "subject",
    IconType: MaterialIcons,
  },
  {
    label: "Alerts",
    route: "/class-incharge/alerts",
    icon: "bell",
    IconType: AntDesign,
  },
  {
    label: "My Profile",
    route: "/class-incharge/profile",
    icon: "account-box",
    IconType: MaterialIcons,
  },
];
...
export default function TeacherTabsLayout() {
  ...
  const handleLogout = async () => {
    ...
    try {
      const token = await AsyncStorage.getItem("authToken");
      await fetch(`${process.env.EXPO_PUBLIC_API_URL}` + "/teacher/logout", {
        method: "POST",
